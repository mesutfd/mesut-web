...
class CharismaProduct(ListView):
    template_name = 'charisma_product_module/product_list.html'
    model = Product
    context_object_name = 'products'


    def get_context_data(self, *, object_list=None, **kwargs):
        context = super(CharismaProduct, self).get_context_data()
    ...
    def get_queryset(self):
        query = super(CharismaProduct, self).get_queryset()
...
class ProductDetailView(DetailView):
    template_name = 'charisma_product_module/product_detail.html'
    model = Product
...
def product_categories_component(request: HttpRequest):
    ...
    return render(request, 'charisma_product_module/components/procudt_categories_component.html', context)
...
def product_brands_component(request: HttpRequest):
    ...
    return render(request, 'charisma_product_module/components/product_brands_component.html', context)
